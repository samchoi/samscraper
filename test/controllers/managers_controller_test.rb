...
class ManagersControllerTest < ActionController::TestCase
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post :create, manager: { name: @manager.name, paypal_id: @manager.paypal_id, square_id: @manager.square_id, venmo_id: @manager.venmo_id }
    end
  ...
  test "should update manager" do
    patch :update, id: @manager, manager: { name: @manager.name, paypal_id: @manager.paypal_id, square_id: @manager.square_id, venmo_id: @manager.venmo_id }
    assert_redirected_to manager_path(assigns(:manager))
  end
